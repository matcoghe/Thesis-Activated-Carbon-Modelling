...
class PSDM():
    def __init__(self, column_data, comp_data, rawdata_df, **kw):
        ...
        ############################################################ //Mathieu: this normally after 'self.jac_sparse_single'
        #alternative fouling: bed weight reduction
        ...
        if 'Fouling alternative' in self.chem_type:
            ...
            #ChatGPT:
            numbers = re.findall(r'\d+', self.chem_type)
        ...
        self.ebed = 1. - self.wt/(self.bedvol*self.rhop)                              #//Mathieu: self.wt is already used here!
        ...
        #//Mathieu: normally here define self.water_type and self.chem_type    
...
# =============================================================================
    def __get_fouling_params(self):
        ...
        '''
        #//Mathieu:
        if 'Fouling alternative' not in self.water_type:
            a1, a2, a3, a4 = foul_params['water'][self.water_type]
        else:
            a1, a2, a3, a4 = foul_params['water']['Organic Free']            
        
        if 'PFAS' not in self.chem_type and 'Fouling alternative' not in self.chem_type:
